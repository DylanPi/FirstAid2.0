  ...
  return function (t) {
    ...
    (function (t, n) {
      ...
      ! function () {
        ...
        var y, b = function (t, e, n) {
          ...
          w = function (t, e, n) {
            return m.iteratee !== y ? m.iteratee(t, e) : null == t ? m.identity : m.isFunction(t) ? b(t, e, n) : m.isObject(t) && !m.isArray(t) ? m.matcher(t) : m.property(t)
          };
        ...
        m.reduce = m.foldl = m.inject = U(1), m.reduceRight = m.foldr = U(-1), m.find = m.detect = function (t, e, n) {
        ...
        m.toArray = function (t) {
          return t ? m.isArray(t) ? f.call(t) : m.isString(t) ? t.match(T) : j(t) ? m.map(t, m.identity) : m.values(t) : []
        }, m.size = function (t) {
          return null == t ? 0 : j(t) ? t.length : m.keys(t).length
        }, m.partition = I(function (t, e, n) {
          t[n ? 0 : 1].push(e)
        ...
        var P = function (t, e, n, r) {
          r = r || [];
          for (var i = r.length, o = 0, s = N(t); o < s; o++) {
            var a = t[o];
        ...
        var k = function (t) {
          return function (e, n, r) {
            n = w(n, r);
            for (var i = N(e), o = t > 0 ? 0 : i - 1; o >= 0 && o < i; o += t)
              if (n(e[o], o, e)) return o;
            return -1
          }
        };
        m.findIndex = k(1), m.findLastIndex = k(-1), m.sortedIndex = function (t, e, n, r) {
          n = w(n, r, 1);
          for (var i = n(e), o = 0, s = N(t); o < s;) {
        ...
        Q = function (t, e, n, r) {
          ...
          if (t !== t) return e !== e;
          var i = typeof t;
          return ("function" === i || "object" === i || "object" == typeof e) && B(t, e, n, r)
        }, B = function (t, e, n, r) {
          ...
          if (n.push(t), r.push(e), o) {
            ...
            for (; u--;)
              if (!Q(t[u], e[u], n, r)) return !1
          } else {
            var l, f = m.keys(t);
            if (u = f.length, m.keys(e).length !== u) return !1;
            for (; u--;)
              if (l = f[u], !E(e, l) || !Q(t[l], e[l], n, r)) return !1
          }
        ...
        m.template = function (t, e, n) {
          ...
          t.replace(r, function (e, n, r, s, a) {
            return o += t.slice(i, a).replace(Y, X), i = a + e.length, n ? o += "'+\n((__t=(" + n + "))==null?'':_.escape(__t))+\n'" : r ? o += "'+\n((__t=(" + r + "))==null?'':__t)+\n'" : s && (o += "';\n" + s + "\n__p+='"), e
    ...
    var r = n(2),
      ...
      m = function (t, e, n, r, i, o, s) {
        ...
        return r && "get" === r.toLowerCase() && (s = u({}, s, i), i = null), g({
          method: r,
          path: a,
          query: s,
          data: i,
    ...
    var r = n(3),
      ...
      u = function (t, e, n) {
        ...
        d && (n = e);
        for (c in n)(l = !h && b && void 0 !== b[c]) && a(m, c) || (f = l ? b[c] : n[c], m[c] = d && "function" != typeof b[c] ? n[c] : _ && l ? o(f, r) : g && b[c] == f ? function (t) {
        ...
        }(f) : v && "function" == typeof f ? o(Function.call, f) : f, v && ((m.virtual || (m.virtual = {}))[c] = f, t & u.R && y && !y[c] && s(y, c, f)))
      };
    ...
    }(), e.colors = ["#0000CC", "#0000FF", "#0033CC", "#0033FF", "#0066CC", "#0066FF", "#0099CC", "#0099FF", "#00CC00", "#00CC33", "#00CC66", "#00CC99", "#00CCCC", "#00CCFF", "#3300CC", "#3300FF", "#3333CC", "#3333FF", "#3366CC", "#3366FF", "#3399CC", "#3399FF", "#33CC00", "#33CC33", "#33CC66", "#33CC99", "#33CCCC", "#33CCFF", "#6600CC", "#6600FF", "#6633CC", "#6633FF", "#66CC00", "#66CC33", "#9900CC", "#9900FF", "#9933CC", "#9933FF", "#99CC00", "#99CC33", "#CC0000", "#CC0033", "#CC0066", "#CC0099", "#CC00CC", "#CC00FF", "#CC3300", "#CC3333", "#CC3366", "#CC3399", "#CC33CC", "#CC33FF", "#CC6600", "#CC6633", "#CC9900", "#CC9933", "#CCCC00", "#CCCC33", "#FF0000", "#FF0033", "#FF0066", "#FF0099", "#FF00CC", "#FF00FF", "#FF3300", "#FF3333", "#FF3366", "#FF3399", "#FF33CC", "#FF33FF", "#FF6600", "#FF6633", "#FF9900", "#FF9933", "#FFCC00", "#FFCC33"], t.exports = n(105)(e), t.exports.formatters.j = function (t) {
      try {
    ...
    var i = n(8),
      ...
      m = function (t) {
        ...
        var y = g++;
        d("request(%d) %s %s %o %o %o", y, e, n, r, i, u);
        var b = _("request"),
          w = b(n, {
            method: e,
            headers: u,
            ...
            if (d("response(%d) %d %O %o", y, t.status, t.data || t.text, t.header), !1 === t.ok) {
              var e = new Error;
              throw e.response = t, e
            }
            return t.data
          }).catch(function (t) {
            throw t.response && (h.enabled("leancloud:request") || p("request(%d) %s %s %o %o %o", y, e, n, r, i, u), p("response(%d) %d %O %o", y, t.response.status, t.response.data || t.response.text, t.response.header), t.statusCode = t.response.status, t.responseText = t.response.text, t.response = t.response.data), t
          });
        return l ? f(w, l) : w
      };
    t.exports = m
    ...
    t.exports = function (t, e, n, p, v, _, g) {
      u(n, e, p);
      ...
      if (j && (b = l(j.call(new t))) !== Object.prototype && b.next && (c(b, O, !0), r || "function" == typeof b[f] || s(b, f, d)), A && C && "values" !== C.name && (S = !0, x = function () {
          return C.call(this)
        }), r && !g || !h && !S && E[f] || s(E, f, x), a[e] = x, a[O] = d, v)
        if (m = {
            values: A ? x : w("values"),
            keys: _ ? x : w("keys"),
            entries: N
    ...
    var r = n(7),
      ...
      u = function () {
        var t, e = n(35)("iframe"),
          r = o.length;
        for (e.style.display = "none", n(54).appendChild(e), e.src = "javascript:", t = e.contentWindow.document, t.open(), t.write("<script>document.F=Object<\/script>"), t.close(), u = t.F; r--;) delete u.prototype[o[r]];
        return u()
      };
    ...
    h && d || (h = function (t) {
      ...
      v.now(s(m, t, 1))
    } : p ? (i = new p, o = i.port2, i.port1.onmessage = y, r = s(o.postMessage, o, 1)) : l.addEventListener && "function" == typeof postMessage && !l.importScripts ? (r = function (t) {
      l.postMessage(t + "", "*")
    ...
    var r = n(2),
      ...
      o = n(0),
      s = n(18);
    s._ = o, s.version = n(64), s.Promise = i.default, s.localStorage = n(66), s.Cache = n(67), s.Error = n(16), n(110), n(126)(s), n(127)(s), n(128)(s), n(129)(s), n(130)(s), n(131)(s), n(139)(s), n(150)(s), n(151)(s), n(153)(s), n(154)(s), n(155)(s), n(156)(s), n(157)(s), n(158)(s), n(159)(s), n(160)(s), s.Conversation = n(161), n(162), t.exports = s
  }, function (t, e, n) {
    n(47), n(24), n(32), n(86), n(97), n(98), t.exports = n(1).Promise
  }, function (t, e, n) {
    var r = n(33),
      i = n(34);
    t.exports = function (t) {
    ...
    var r, i, o, s, a = n(21),
      ...
      I = !! function () {
        try {
          ...
          return (N || "function" == typeof PromiseRejectionEvent) && t.then(j) instanceof e && 0 !== C.indexOf("6.6") && -1 === w.indexOf("Chrome/66")
        } catch (t) {}
      }(),
      T = function (t) {
        var e;
          ...
          m(function () {
            for (var r = t._v, i = 1 == t._s, o = 0; n.length > o;) ! function (e) {
              var n, o, s, a = i ? e.ok : e.fail,
                ...
                l = e.domain;
              try {
                a ? (i || (2 == t._h && D(t), t._h = 1), !0 === a ? n = r : (l && l.enter(), n = a(r), l && (l.exit(), s = !0)), n === e.promise ? c(A("Promise-chain cycle")) : (o = T(n)) ? o.call(n, u, c) : u(n)) : c(r)
              } catch (t) {
                l && !s && l.exit(), c(t)
              }
            }(n[o++]);
      ...
      k = function (t) {
        g.call(u, function () {
          var e, n, r, i = t._v,
            o = R(t);
          if (o && (e = b(function () {
              N ? S.emit("unhandledRejection", i, t) : (n = u.onunhandledrejection) ? n({
                promise: t,
                reason: i
              }) : (r = u.console) && r.error && r.error("Unhandled promise rejection", i)
            }), t._h = N || R(t) ? 2 : 1), t._a = void 0, o && e.e) throw e.v
        })
      },
      R = function (t) {
      ...
      D = function (t) {
        g.call(u, function () {
          var e;
          N ? S.emit("rejectionHandled", t) : (e = u.onrejectionhandled) && e({
            promise: t,
            reason: t._v
          })
        })
    ...
    I || (x = function (t) {
      ...
      var t = new r;
      this.promise = t, this.resolve = c(F, t, 1), this.reject = c(M, t, 1)
    }, y.f = U = function (t) {
      return t === x || t === s ? new o(t) : i(t)
    }), f(f.G + f.W + f.F * !I, {
      Promise: x
    }), n(30)(x, "Promise"), n(95)("Promise"), s = n(1).Promise, f(f.S + f.F * !I, "Promise", {
      reject: function (t) {
        var e = U(this);
      ...
      e = t.exports = function (t, e, n, f, h) {
        ...
        if (o(g)) {
          for (d = a(t.length); d > y; y++)
            if ((_ = e ? m(s(p = t[y])[0], p[1]) : m(t[y])) === c || _ === l) return _
        } else
    ...
    n(102), t.exports = n(1).Object.keys
  }, function (t, e, n) {
    var r = n(31),
      i = n(28);
    n(42)("keys", function () {
    ...
    function r(t) {
      ...
      return r.debug = r, r.default = r, r.coerce = c, r.disable = a, r.enable = s, r.enabled = u, r.humanize = n(106), Object.keys(t).forEach(function (e) {
        r[e] = t[e]
    ...
    n(109), t.exports = n(1).Object.getPrototypeOf
  }, function (t, e, n) {
    var r = n(31),
      i = n(55);
    ...
    s.init = function (t) {
      ...
      var e = t.appId,
        ...
        y = t.production,
        b = t.realtime;
      if (g && console.warn("Initializing LeanCloud Storage SDK which has already been initialized. Reinitializing the SDK might cause problems like unexpected cross-app data writing and invalid relations."), !e) throw new TypeError("appId must be a string");
      ...
      e !== s._config.applicationId ? (s._config.masterKey = i, s._config.hookKey = o) : (i && (s._config.masterKey = i), o && (s._config.hookKey = o)), s._config.applicationId = e, s._config.applicationKey = n, s.setProduction(y), void 0 !== m && (s._config.disableCurrentUser = m);
      var w = _ || void 0 !== l;
      if (w || (s._appRouter = new a(s)), s._setServerURLs(f({}, r(e), s._config.serverURLs, "string" == typeof l ? v(l) : l), w), b) s._config.realtime = b;
    ...
    n(24), n(32), t.exports = n(44).f("iterator")
  }, function (t, e, n) {
    t.exports = {
      default: n(117),
      __esModule: !0
    ...
    n(118), n(47), n(123), n(124), t.exports = n(1).Symbol
  }, function (t, e, n) {
    "use strict";
    var r = n(3),
      i = n(14),
      ...
      z = B && "symbol" == typeof P.iterator ? function (t) {
        return "symbol" == typeof t
      } : function (t) {
        return t instanceof P
      },
      H = function (t, e, n) {
        return t === Q && H(W, e, n), m(t), e = O(e, !0), m(n), i(q, e) ? (n.enumerable ? (i(t, D) && t[D][e] && (t[D][e] = !1), n = S(n, {
          enumerable: A(0, !1)
        })) : (i(t, D) || I(t, D, A(1, {})), t[D][e] = !0), J(t, e, n)) : I(t, e, n)
      },
      $ = function (t, e) {
        m(t);
      ...
      X = function (t) {
        ...
        return !(this === Q && i(q, t) && !i(W, t)) && (!(e || !i(this, t) || !i(q, t) || i(this, D) && this[D][t]) || e)
      },
      Z = function (t, e) {
        if (t = w(t), e = O(e, !0), t !== Q || !i(q, e) || i(W, e)) {
          var n = U(t, e);
          return !n || !i(q, e) || i(t, D) && t[D][e] || (n.enumerable = !0), n
        }
      },
      tt = function (t) {
        for (var e, n = T(w(t)), r = [], o = 0; n.length > o;) i(q, e = n[o++]) || e == D || e == u || r.push(e);
        return r
      },
      et = function (t) {
        for (var e, n = t === Q, r = T(n ? W : w(t)), o = [], s = 0; r.length > s;) !i(q, e = r[s++]) || n && !i(Q, e) || o.push(q[e]);
        return o
      };
    B || (P = function () {
      ...
      var t = h(arguments.length > 0 ? arguments[0] : void 0),
        e = function (n) {
          this === Q && e.call(W, n), i(this, D) && i(this[D], t) && (this[D][t] = !1), J(this, t, A(1, n))
        };
      return o && K && J(Q, t, {
        configurable: !0,
        set: e
      ...
      return this._k
    }), C.f = Z, N.f = H, n(71).f = E.f = tt, n(46).f = X, x.f = et, o && !n(21) && a(Q, "propertyIsEnumerable", X, !0), p.f = function (t) {
      return G(d(t))
    }), s(s.G + s.W + s.F * !B, {
      Symbol: P
    });
    ...
    s(s.S + s.F * st, "Object", {
      ...
      stringify: function (t) {
        ...
        if (n = e = r[1], (y(e) || void 0 !== t) && !z(t)) return g(e) || (e = function (t, e) {
    ...
    t.exports = function (t) {
      t.Object = function (e, n) {
        ...
        add: function (e, n) {
          return this.set(e, new t.Op.Add(y(n)))
        },
        addUnique: function (e, n) {
          return this.set(e, new t.Op.AddUnique(y(n)))
        },
        remove: function (e, n) {
          return this.set(e, new t.Op.Remove(y(n)))
        },
        bitAnd: function (e, n) {
        ...
        revert: function (t) {
          var e = d.last(this._opSetQueue);
          return y(t || d.keys(e)).forEach(function (t) {
            delete e[t]
        ...
        fetch: function () {
          ...
          return _("classes", this.className, this.id, "GET", b(t), e).then(function (e) {
            var r = n.parse(e);
            return n._cleanupUnsetKeys(r, t.keys ? y(t.keys).join(",").split(",") : void 0), n._finishFetch(r, !0), n
          })
        },
    ...
    t.exports = function (t) {
      t.User = t.Object.extend("_User", {
        ...
        associateWithMiniApp: function (t, e) {
          var n = this;
          if (void 0 === t) {
            return g("getAuthInfo")().then(function (t) {
